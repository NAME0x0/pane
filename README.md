...
- width-aware legacy PIC/PIT/CMOS RTC/system-control/PCI-config/i8042/VGA probe port handling with explicit unsupported-I/O blockers for the next device-model gap,
