...
- Pane-owned virtio-MMIO block register model at `0x0dfc0000`, mapped into storage-backed kernel layouts with modern virtio identity/config registers plus tested split-virtqueue descriptor-chain execution while WHP instruction-emulator callback wiring remains pending,
