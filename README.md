...
- Pane-owned virtio-MMIO block register model at `0x0dfc0000`, mapped into storage-backed kernel layouts with modern virtio identity/config registers, tested split-virtqueue descriptor-chain execution, and a typed MMIO service boundary while live WHP instruction-emulator callback wiring remains pending,
