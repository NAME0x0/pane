...
- typed crosvm-style WHP device-loop reporting in `native-preflight` and `native-boot-spike`, covering serial, diagnostic block I/O, planned virtio-blk, legacy platform I/O, timer interrupts, display, input, and CPU-control exits,
