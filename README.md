...
- Linux `boot_params.screen_info` population for the Pane framebuffer so early Linux boot receives a standard framebuffer description rather than only Pane-specific cmdline metadata,
