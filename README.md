...
- Pane-owned virtio-MMIO block register model at `0x0dfc0000`, mapped into storage-backed kernel layouts with modern virtio identity/config registers while split-virtqueue descriptor execution remains pending,
