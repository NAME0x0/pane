...
- native block I/O policy, stateful Pane block-port protocol, WHP block-port classification, host callback submission, and a guest-visible byte-stream response window for the future storage device,
