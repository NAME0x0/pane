...
- kernel-layout attachment for the verified Arch base image plus guest-mapped Pane sparse user disk, block-port submit/status ABI, and shared-memory transfer window,
