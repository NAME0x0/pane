...
- native block I/O policy, stateful Pane block-port protocol, and WHP block-port classification for the future guest-visible storage device,
- host-side native block I/O adapter that routes base reads and user-disk reads/writes through verified Pane artifacts,
