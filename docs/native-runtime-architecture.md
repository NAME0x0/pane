...
- verified Pane user disk snapshots under the runtime snapshot store for recovery/export/import milestones,
...
10. Storage materialization: turn the descriptor into a durable block-device format with resize, snapshot, repair, export, and import semantics. Pane now has a verified user-disk snapshot artifact; restore, resize, export, and import remain explicit future increments.
