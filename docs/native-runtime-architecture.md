...
- a native block I/O command policy, stateful Pane block-port register protocol, WHP Pane block-port classification boundary, host callback submission path, and guest-visible byte-stream response window for the future storage device,
