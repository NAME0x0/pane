...
- a materialized storage attachment in the kernel layout when the verified Arch base image and Pane user disk are present, including sparse disk geometry and header verification data,
