...
- storage-backed layouts reserve and map a Pane-owned modern virtio-MMIO block register page at `0x0dfc0000`, with queue descriptor execution still pending,
