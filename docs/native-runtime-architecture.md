...
- a first Pane-owned framebuffer contract mapped into guest memory for the future app-rendered display boundary, plus host-side framebuffer snapshot reporting after guarded WHP runs,
