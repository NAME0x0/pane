...
- controlled candidates enter with the real-mode serial/HALT register contract, while Linux bzImage payloads enter with the protected-mode contract and boot params in `rsi`,
